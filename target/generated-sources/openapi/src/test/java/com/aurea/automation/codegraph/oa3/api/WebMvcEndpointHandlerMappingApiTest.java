...
/**
 * API tests for WebMvcEndpointHandlerMappingApi
 */
@Ignore
public class WebMvcEndpointHandlerMappingApiTest {

    private WebMvcEndpointHandlerMappingApi api;
     ...
     */
    @Test
    public void shouldSee200AfterLinksUsingGET() {
